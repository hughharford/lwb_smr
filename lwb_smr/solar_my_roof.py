...
class SolarMyRoof():
    ...
    def output_completed_mask(self):
        ...
        try:
            ...
            # self.pred_roof.total_roof_area()
    ...
    def get_custom_roof_area(self):
        '''
        user input to get roof area in m^2
        '''
        roof_area = self.pred_roof.get_roof_area()
        return roof_area

    # def get_total_roof_area(self):
    #     return self.total_roof_area
